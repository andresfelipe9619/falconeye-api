module.exports = {
  up: async(queryInterface) => {
    ...
    await queryInterface.bulkInsert("sg_layers_attributes", SG_LAYERS_ATTRIBUTES, {});
...
const SG_NUMRANGES = [
  { createdAt: new Date(), updatedAt: new Date(), name: "Rango1" },
  { createdAt: new Date(), updatedAt: new Date(), name: "Rango2" },
  { createdAt: new Date(), updatedAt: new Date(), name: "Rango3" },
  { createdAt: new Date(), updatedAt: new Date(), name: "Rango4" },
];
...
const SG_MARKERS = [
  ...
  { createdAt: new Date(), updatedAt: new Date(), name: "Mark3", color: "Red" },
  {
    createdAt: new Date(),
    updatedAt: new Date(),
    name: "Mark4",
